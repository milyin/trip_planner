...
- **Routes**: all stored routes with selectable, selected, or disabled status; an `Add →` button moves a route into the plan. Each card shows the **trip duration**, and hovering reveals the full untrimmed text of any ellipsized title/address.
